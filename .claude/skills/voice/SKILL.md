...
Template for a fresh `Areas/Writing Voice.md`:
    ...
    ---
    # Writing Voice
    What Claude knows about how I write. Correct anything wrong — this file is the memory.
    ## Observations
    ## Rules
...
- No "not just X, but Y" constructions. No rule-of-three lists reflexively. No headers/bullets in short emails — prose.
